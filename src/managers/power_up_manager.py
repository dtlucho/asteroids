...
class PowerUpManager:
    ...
    def __init__(self: "PowerUpManager", spawn_interval_range: tuple = (1, 3)):
        """
    ...
    def update(self: "PowerUpManager", dt: float, player: "Player") -> bool:
        """
    ...
    def spawn_power_up(
        self: "PowerUpManager", avoid_position: pygame.Vector2 | None = None
    ) -> "PowerUp":
        """
    ...
    def draw(self: "PowerUpManager", screen: pygame.Surface):
        """
        Draw all power-ups.
