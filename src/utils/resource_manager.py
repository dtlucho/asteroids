...
class ResourceManager:
    ...
    def __init__(self: "ResourceManager"):
        ...
        # Path to retro font
        self.retro_font_path = os.path.join(
            self.assets_dir, "fonts", "arcade_classic.ttf"
        )
    ...
    def load_image(
        self: "ResourceManager", path: str, convert_alpha: bool = True
    ) -> pygame.Surface:
        """
    ...
    def load_sound(self: "ResourceManager", path: str) -> pygame.mixer.Sound:
        """
    ...
    def clear_cache(self: "ResourceManager", resource_type: str | None = None):
        """
